...
function maxSubarray2Sum(arr:number[], n:number){
...
console.log(maxSubarraySum([2, -3, -5, 1,-100, 98,-97,-1,1,2,-8, -96, 100, -98] , 2))
console.log(maxSubarray2Sum([2, -3, -5, 1,-100, 98,-97,-1,1,2,-8, -96, 100, -98] , 2))
